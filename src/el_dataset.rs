    ...
    for (line_num, line) in reader.lines().enumerate() {
        ...
        match parts[0] {
            "NF1" => {
                if parts.len() != 4 {
                    return Err(BoxError::Internal(format!(
                        "line {}: NF1 requires 3 fields (C1, C2, D), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "NF2" => {
                if parts.len() != 3 {
                    return Err(BoxError::Internal(format!(
                        "line {}: NF2 requires 2 fields (C, D), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "NF3" => {
                if parts.len() != 4 {
                    return Err(BoxError::Internal(format!(
                        "line {}: NF3 requires 3 fields (C, r, D), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "NF4" => {
                if parts.len() != 4 {
                    return Err(BoxError::Internal(format!(
                        "line {}: NF4 requires 3 fields (r, C, D), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "RI6" => {
                if parts.len() != 3 {
                    return Err(BoxError::Internal(format!(
                        "line {}: RI6 requires 2 fields (r, s), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "RI7" => {
                if parts.len() != 4 {
                    return Err(BoxError::Internal(format!(
                        "line {}: RI7 requires 3 fields (r, s, t), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            "DISJ" => {
                if parts.len() != 3 {
                    return Err(BoxError::Internal(format!(
                        "line {}: DISJ requires 2 fields (C, D), got {}",
                        line_num + 1,
                        parts.len() - 1
                    )));
                }
            ...
            tag => {
                return Err(BoxError::Internal(format!(
                    "line {}: unknown axiom tag '{}' (expected NF1/NF2/NF3/NF4/RI6/RI7/DISJ)",
                    line_num + 1,
                    tag
                )));
            }
