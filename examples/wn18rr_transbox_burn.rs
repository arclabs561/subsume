//! Batched TransBox embedding training on WN18RR using the Burn backend.
//!
//! Run (CPU):
//!   cargo run --features burn-ndarray --example wn18rr_transbox_burn --release
//!
//! Environment variables (all optional):
//!   DIM, EPOCHS, LR, MARGIN, NEG, BATCH, ADV_TEMP, REG, TRAIN_LIMIT, REPORT_EVERY
...
use subsume::trainer::burn_transbox_trainer::BurnTransBoxTrainer;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("=== WN18RR TransBox Embedding Training (Burn) ===\n");
    ...
    let mut trainer = BurnTransBoxTrainer::<Backend>::new();
