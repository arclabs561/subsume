...
**Note:** In Gumbel boxes, minimum coordinates use MinGumbel (tends toward lower values) and maximum coordinates use MaxGumbel (tends toward higher values), ensuring $z_i \lt Z_i$ with high probability while maintaining gradient flow.
