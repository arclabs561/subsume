...
fn main() -> Result<(), std::boxed::Box<dyn std::error::Error>> {
    ...
    let original_box = NdarrayBox::new(array![0.0, 1.0, 2.0], array![1.0, 2.0, 3.0], 1.5)?;
    ...
    // Deserialize it back
    let deserialized_box: NdarrayBox =
        serde_json::from_str(&json).map_err(|e| subsume_core::BoxError::Internal(e.to_string()))?;
    println!("\n2. Deserialized box:");
    ...
    let gumbel_box = NdarrayGumbelBox::new(array![0.0, 0.0], array![1.0, 1.0], 0.5)?;
